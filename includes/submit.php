...
if (!isset($_FILES[$input_name])) {
    $error = 'Файл не загружен. Нет массива $_FILES';
} else {
    ...
    if (!empty($file['error']) || empty($file['tmp_name'])) {
        ...
        //Передаю путь до файла для БД
        $path_to_file = 'uploads/'.$name;
        //setcookie("PATH_TO_FILE", $path_to_file);
        $_SESSION['PATH'] = $path_to_file;
